        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> React and Node.js. </b>
              </i>
              <br />
              <br />
              My field of Interest's are building scalable &nbsp;
              <i>
                <b className="purple">Web Applications and APIs </b> and
              ...
              with <b className="purple">Modern Frameworks</b> and
              <i>
                <b className="purple">
                  {" "}
                  Best Practices
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://linkedin.com/in/ahmed-alowais-407816171"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
